...
![Plain60-B PCB](https://i.imgur.com/OwOP9Vb.png)
...
## Features
- QMK Firmware
- Compatible with most universal 60% cases
- Mini USB
...
## Supported layouts
![Supported layouts of the Plain60-B](https://i.imgur.com/HtLYU8R.png)
